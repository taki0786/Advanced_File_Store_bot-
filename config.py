...
#start message
START_MSG = os.environ.get("START_MESSAGE", "<b> Kᴏɴɴɪᴄʜɪᴡᴀ {first} 👋 </b>\n\nI am pleased to inform you that I can provide you Anime Files with With Special Link Generated By Admin. To access these links, please visit our Channel at @jjustanime.")
try:
    ADMINS=[6376328008]
